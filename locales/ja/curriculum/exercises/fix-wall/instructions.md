...
常に幅100、高さ100のキャンバスに描画します。したがって、キャンバスの左上は `0,0`、右下は `100,100` です。
...
**キャンバスにカーソルを合わせると**、座標を確認できます。

もっと楽に進められるように、**使う数値はすべて10で割り切れます**（たとえば`10`、`20`、`30`などは使えますが、`5`、`12`、`25`などは使えません）。
