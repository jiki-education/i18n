...
この演習には、さまざまな正しい解法があります。`continue`文を試してみるのもよいでしょうが、ほかにもよい解法がたくさんあります。

また、全体を42行以内のコードで書くことに挑戦するボーナスタスクもあります。この目標が必ずしも実際の開発で理想的なコードとは限りません。数行増やした方がもっと良い解答になることもありますし、もっと短い解答も存在します。しかし、自分の力を伸ばすためのよい目標です。
