...
excerpt: "Step by step instructions for installing Visual Studio Code on Windows, macOS, and Linux."
...
Visual Studio Code (VS Code) is a free code editor made by Microsoft that runs on Windows, macOS, and Linux. It is the editor we recommend while you are learning to code. If you are not sure what a code editor is or why you need one, start with our guide on [using a code editor](/guides/using-a-code-editor).
...
1. Open [code.visualstudio.com](https://code.visualstudio.com) in your web browser.
