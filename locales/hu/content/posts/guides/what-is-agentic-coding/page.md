...
Igen, de tudatosan. Van itt egy csapda: ha megkéred az ügynököt, hogy végezze el helyetted a tanulási feladatokat, boldogan megteszi, te pedig semmit sem tanulsz. Ez olyan, mintha beiratkoznál egy edzőterembe, és fizetnél valakinek, hogy helyetted emelje a súlyokat.

Ha viszont jól használod, az egyik legjobb tanulási eszköz, ami valaha létezett. Egy türelmes, mindig elérhető szakértő, aki elmagyaráz bármilyen kódsort, válaszol bármilyen „de miért?” kérdésre, és megmutatja, hogyan közelítene egy profi egy problémához. A tanácsunk:

- **A gyakorlatok megoldásait magad írd meg.** A küzdelem az, ahol a tanulás történik.
- **Kérd meg az ügynököt, hogy magyarázzon, ne oldjon meg.** A „Miért nem működik?” többet tanít, mint a „javítsd ki”.
- **Figyeld, ahogy dolgozik eldobható projekteken.** Az, ahogyan felbontja a problémákat, önmagában is tanulság.
...
## Néhány szó a változások üteméről

Ezen a területen minden gyorsan változik. Az eszközök átnevezik magukat, az ingyenes csomagok feltűnnek és eltűnnek, a „legjobb” modell pedig néhány havonta változik. Ezeket az útmutatókat naprakészen tartjuk (nézd meg a „legutóbbi frissítés” dátumát a tetején), de ne lepődj meg, ha egy képernyőkép kissé másképp néz ki, mire követed. Az alapok, amelyekre ezek az útmutatók fókuszálnak, sokkal lassabban változnak, mint a logók.
