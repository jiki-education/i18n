...
A szavakat szóközök választják el egymástól. De van egy dolog, amire érdemes figyelni... Néha az ügyfelek véletlenül több egymást követő szóközzel küldik el a cégnevüket. Ha ez megtörténik, figyelmen kívül kell hagynod őket, így a <code>"Frank's&nbsp;&nbsp;&nbsp;Hotdogs"</code> bemenet esetén is a `["Frank's", "Hotdogs"]` láncot kell visszaadnia.
