---
title: "After Party"
description: "Derítsd ki, hány vendéget hozhat magával egy híresség, két egymáshoz igazodó tömb alapján."
...
Ma este két lista van a vágólapodon. Az első a `names`, a meghívottak teljes neveivel. A második a `plusOnes`, hogy hány extra embert hozhat magával minden vendég (a plusz egyeik (_plus-ones_ angolul)). A két lista együtt, tételről tételre, ugyanabban a sorrendben készült, tehát egymáshoz igazodnak. Például a names tömb harmadik eleme ugyanahhoz a személyhez tartozik, mint a plusOnes tömb harmadik eleme.

Írj egy `plusOnesFor` (plusz egyek lekérdezése) nevű függvényt. A függvénynek három bemenete van: a `names` tömb, a `plusOnes` tömb, és annak a **keresztneve**, aki éppen előtted áll. A függvény adja vissza, hogy az illető hány extra vendéget hozhat magával.
