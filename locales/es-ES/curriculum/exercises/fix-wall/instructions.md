...
Para dibujar rectángulos necesitamos saber la posición superior, la izquierda, el ancho y la altura del rectángulo. Cuando usamos la función `rectangle`, podemos especificarlos como entradas (_inputs_ en inglés):
...
### Averiguar las coordenadas correctas

Puedes **pasar el cursor sobre la zona de dibujo** para ver las coordenadas.
