...
Te dibujamos una plantilla. Tus formas deben quedar justo dentro de las líneas. También añadimos la base de la nube en el código para facilitarte un poco las cosas. **No puedes cambiar esta línea** (verás que está atenuada y tiene un símbolo de bloqueo al lado).
