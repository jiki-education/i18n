...
Este ejercicio te presenta la función `triangle` (triángulo). La usas con 7 entradas. Las 6 primeras entradas son pares de coordenadas para las tres esquinas. La última entrada es el `color`:
...
(¡Asegúrate de usar esos colores al dibujar los triángulos y recuerda comprobar que los escribes como _strings_ (cadenas de caracteres)!)
