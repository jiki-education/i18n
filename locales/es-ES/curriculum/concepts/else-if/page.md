...
description: "Encadenar cláusulas `else if` para verificar varias condiciones en orden, ejecutando únicamente el primer bloque cuya condición sea verdadera."
