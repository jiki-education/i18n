...
description: "Colocar un bucle dentro de otro para que el bucle interno se ejecute por completo en cada paso del bucle externo, lo que resulta perfecto para cuadrículas."
