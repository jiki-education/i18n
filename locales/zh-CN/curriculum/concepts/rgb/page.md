---
title: "RGB 颜色"
description: "混合红、绿、蓝三色光，从 0 到 255，在屏幕上调出你想要的任何颜色。"
en_md5: 8ed038f6d17072b6fb6eaae6bef15c2c
---

RGB 让我们可以把颜色想象成红、绿、蓝的混合。这就是 RGB 的含义：红色（英文：_red (R)_）、绿色（英文：_green (G)_）、蓝色（英文：_blue (B)_）。如果你还记得在学校里混合颜料，这很类似，只是我们混合的不是涂料，而是光。
