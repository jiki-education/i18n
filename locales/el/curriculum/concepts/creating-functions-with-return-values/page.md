...
description: "Χρησιμοποιώντας τη λέξη-κλειδί `return` για να δώσεις στις δικές σου συναρτήσεις μια τσουλήθρα εξόδου που επιστρέφει μια τιμή πίσω στον καλούντα."
