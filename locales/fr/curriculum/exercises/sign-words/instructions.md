...
Les mots sont séparés par des espaces. Mais attention à une chose... Il arrive que des clients envoient par accident un nom d'entreprise qui contient plusieurs espaces à la suite. Dans ce cas, il faut les ignorer : <code>"Frank's&nbsp;&nbsp;&nbsp;Hotdogs"</code> doit donc quand même renvoyer `["Frank's", "Hotdogs"]`.
