---
title: "L'after"
description: "Retrouve combien d'invités une célébrité peut faire entrer, à l'aide de deux tableaux alignés."
...
Ce soir, il y a deux listes sur ton porte-bloc. La première, `names`, contient les noms complets de toutes les personnes invitées. La seconde, `plusOnes`, indique combien de personnes supplémentaires chacun de ces invités a le droit de faire entrer avec lui (ses « +1 », _plus-ones_ en anglais). Les deux listes ont été écrites ensemble, entrée par entrée, dans le même ordre : elles sont donc alignées. Par exemple, la troisième entrée du tableau des noms correspond à la même personne que la troisième entrée du tableau plusOnes.

Écris une fonction appelée `plusOnesFor` (« les +1 de »). La fonction a trois entrées : le tableau `names`, le tableau `plusOnes`, et le **prénom** de la personne qui se tient devant toi en ce moment. Tu dois renvoyer le nombre d'invités supplémentaires que cette personne a le droit de faire entrer.
