...
description: "Inserire un ciclo dentro un altro, in modo che il ciclo interno venga eseguito completamente per ogni passo del ciclo esterno: è perfetto per le griglie."
