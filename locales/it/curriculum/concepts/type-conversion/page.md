...
description: "Trasformare un valore da un tipo all'altro, come convertire una stringa di cifre in un numero con `Number()`, o un numero in una stringa con `String()`."
